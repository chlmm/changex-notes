...
**执行结果：**
- 创建目录: `资源学习/书籍/非虚构/如何避免孤独终老/`
- 创建笔记: `资源学习/书籍/非虚构/如何避免孤独终老/index.md`
...
1. **保留原文件**：不删除原有 `书籍/` 目录的文件
2. **创建新结构**：在 `资源学习/书籍/` 下按新结构创建
